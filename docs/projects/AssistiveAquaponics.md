...
{.marginnote}Aquaponics Circle Diagram - System of Recirulation{/.marginnote}
...
{.marginnote}Aquaponics System Diagram - A more Colorful System Depiction{/.marginnote}
...
{.marginnote}Deswati, et al. “The Effectiveness of Aquaponic Compared to Modified Conventional Aquaculture for Improved of Ammonia, Nitrite, and Nitrate.” Rasayan Journal of Chemistry, vol. 13, no. 1, Jan. 2020, p. 1. EBSCOhost, search.ebscohost.com/login.aspx?direct=true&db=edb&AN=142699175&site=eds-live.{/.marginnote}
...
{.marginnote}Some Notes and Sketches of the Aquaponics Fish Tank{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/Sketch1.png" alt="">
<img src="../../assets/images/AssistiveAquaponics/Sketch2.png" alt="">
</div>
...
<img src="../../assets/images/AssistiveAquaponics/InkscapeBowl.png" alt="">
<img src="../../assets/images/AssistiveAquaponics/InkscapeFish.png" alt="">
<img src="../../assets/images/AssistiveAquaponics/InkscapeTW.png" alt="">
</div>
...
{.marginnote}Final Project Board With All Trace Routed, and Icons Imported{/.marginnote}
...
{.marginnote}Sixth Itteration Fish Bowl Board Schematic{/.marginnote}

{.marginnote}Sixth Itteration Fish Bowl Board File{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/FishBowlSchematicv4.png" alt="">
<img src="../../assets/images/AssistiveAquaponics/FishBowlBoardv4.png" alt="">
</div>
...
{.marginnote}Seventh Itteration of the Fish Bowl Main Board Schematic{/.marginnote}
...
{.marginnote}Seventh First Itteration of the Fish Bowl Main Board{/.marginnote}
...
{.marginnote}Seventh Itteration of the Fish Bowl Main Board Stuffed & Soldered{/.marginnote}
...
{.marginnote}One Error Message Recieved Upon a Bootloader Burning Attempt{/.marginnote}
...
{.marginnote}Eight Itteration of the Fish Bowl Main Board With Smoothing Cap{/.marginnote}
...
{.marginnote}Sashakit ATMega 328p Bootloader Burning Setup{/.marginnote}
...
{.marginnote}Working Iterration of the ATMega 328 Fish Bowl Board{/.marginnote}
...
{.marginnote}Blinky Example Sketch Running on my Fish Bowl Board{/.marginnote}
...
{.marginnote}All Fish Bowl Board Attempts Up to First Working Itteration{/.marginnote}
...
{.marginnote}ATTiny 1614 pH Probe Interfacing Board Eagle Files{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/pHschem.png" alt="">
<img src="../../assets/images/AssistiveAquaponics/pHboardfile.png" alt="">
</div>
...
{.marginnote}pH probe wired to all three pH interfacing boards{/.marginnote}
...
{.marginnote}Final Tempeture and Humitidy Monetering Fish Board{/.marginnote}
...
{.marginnote}Fish Tempature and Humidity Sensor Board{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/milledfish.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/solderedfish.jpg" alt="">
</div>
...
{.marginnote}Compleated LCD and Breakout Board Assembly{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/lcdboardsoldered2.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/lcdboardsoldered1.jpg" alt="">
</div>
...
{.marginnote}Aquaponics Fish Tank LCD Bootscreen Code{/.marginnote}
...
{.marginnote}Aquaponics Fish Tank LCD Bootscreen Implemented in Void Setup{/.marginnote}
...
{.marginnote}First Itteration of the Aquaponics Fish Tank LCD Statusscreen{/.marginnote}
...
{.marginnote}Updated Software Serial Code Running on my System{/.marginnote}
...
{.marginnote}Power Breakout Board Eagle Schematic{/.marginnote}
...
{.marginnote}Power Breakout Board Eagle Board File{/.marginnote}
...
{.marginnote}Final Power Breakout Board Eagle Schematic{/.marginnote}
...
{.marginnote}Final Power Breakout Board Eagle Board File{/.marginnote}
...
{.marginnote}Final Fabricated Power Breakout Board{/.marginnote}
...
{.marginnote}Fusion Model with Projected Sketches for Each Component{/.marginnote}
...
{.marginnote}Final Shots of Sanded Fish Tank Structure{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/Final1.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/Final2.jpg" alt="">
</div>
...
{.marginnote}Mains AC Adapter and Switch Box Mounting Hole{/.marginnote}
...
<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/powerinput.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/powerinput2.jpg" alt="">
</div>
...
{.marginnote}Front Panle Electronics Clearence Hole Layout{/.marginnote}
...
{.marginnote}Water-Tight Test on Sealed Tank - Three Hour Mark{/.marginnote}
...
{.marginnote}BTT Rubber Duckies Enjoying the Water-Tight Tank{/.marginnote}
...
{.marginnote}Final Plant Box Itteration in Fusion 360{/.marginnote}
...
{.marginnote}Board Prototype Fitted in Fish Bowl Board Mount{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/BoardMountTop.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/BoardMountSide.jpg" alt="">
</div>
...
{.marginnote}12x Jumper Mount On Jumper Cables{/.marginnote}
...
{.marginnote}Power Supply Mounting Brackets After Cleanup{/.marginnote}

{.marginnote}Power Supply Mounts Attached to PSU{/.marginnote}
...
{.marginnote}Back Wire Grommet After Cleanup{/.marginnote}

{.marginnote}Back Wire Grommet Fitted to Wire Passthrough Hole{/.marginnote}
...
{.marginnote}PSU Terminal Cover Plate After Cleanup{/.marginnote}

{.marginnote}PSU Terminal Cover Mounted to PSU Terminals{/.marginnote}
...
{.marginnote}Power Breakout Board Fitted in Board Mount{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/powerbreakouttop.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/powerbreakoutside.jpg" alt="">
</div>
...
{.marginnote}pH electrical Isolation Board Mounted on Board Mount{/.marginnote}
...
{.marginnote}Assembled pH Probe Mount After Cleanup{/.marginnote}
...
{.marginnote}Cable Bundle Clip Mounted to Back of Tank Structure{/.marginnote}
...
{.marginnote}Power Supply Terminal Wireing{/.marginnote}
...
{.marginnote}Begining of System Integraiton - PSU and Main Board{/.marginnote}
...
{.marginnote}Acrylic Fish Tank Installed in Plywood Structure{/.marginnote}
...
{.marginnote}Bottom of Plant Box After Electronics & Cable Installation{/.marginnote}
...
{.marginnote}Plant Box Installed in Tank Structure Above Acrylic Tank{/.marginnote}

<div class="figure-grid grid-2x1">
<img src="../../assets/images/AssistiveAquaponics/plantboxfront.jpg" alt="">
<img src="../../assets/images/AssistiveAquaponics/plantboxback.jpg" alt="">
</div>
...
{.marginnote}Grow Light Cables Routed Through Plant Box Cable Passthrough{/.marginnote}
...
{.marginnote}System Grow & Tank Lights Testing{/.marginnote}
...
{.marginnote}pH Probe Mounted in Back Left Tank Corner{/.marginnote}
...
{.marginnote}Water Pump Connected & Installed in Tank{/.marginnote}
...
{.marginnote}Cable Routing From Plant Box to Electronics Compartment{/.marginnote}
...
{.marginnote}All Board Mounted Electronics Compartment{/.marginnote}
...
{.marginnote}Final Cable Managed Electronics Compartment{/.marginnote}
